    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mt-4">
                <h4><a href="index.php"> RESTORAN B.SUSI </a></h4>
            </div>
                ...
                <?php if (!empty($row)) { ?>
                    <ul class="nav flex-column">
                        <?php foreach ($row as $r) : ?>
                            <li class="nav-item"><a class="nav-link" href="?=home&m=produk&id=<?php echo $r['idkategori'] ?>"><?php echo $r['kategori'] ?></a></li>
                        <?php endforeach ?>
                    </ul>
                <?php } ?>
            </div>
        ...
        <div class="row mt-5">
            <div class="col">
                <p class="text-center">2022 - copyright@eriko32.com</p>
            </div>
        </div>
    </div>
    </div>
